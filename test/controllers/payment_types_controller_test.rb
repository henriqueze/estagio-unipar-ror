...
class PaymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post payment_types_url, params: { payment_type: { description: @payment_type.description, interest_rates: @payment_type.interest_rates, kind: @payment_type.kind, max_parcel: @payment_type.max_parcel } }
    end
  ...
  test "should update payment_type" do
    patch payment_type_url(@payment_type), params: { payment_type: { description: @payment_type.description, interest_rates: @payment_type.interest_rates, kind: @payment_type.kind, max_parcel: @payment_type.max_parcel } }
